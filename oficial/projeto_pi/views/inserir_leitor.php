<div class="container">
  <div class="row">
    ...
    <div class="col-6"> 
    	...
    	<h2 style="text-align:center">Inserir Leitor</h2><br>
		...
		<?php } else{ ?>
			<?php while($linha = mysqli_fetch_array($consulta_leitor)){ ?>
		...
		<form  method="post" action="edita_leitor.php">
			 ...
			 <div class="form-group">
			    ...
			    <input type="text" class="form-control" id="formGroupExampleInput" name="telefone_leitor" placeholder="Insira a telefone do leitor" value="<?php print $linha['telefone_leitor']; ?>"><br>
			    <center><input class="btn btn-dark" type="submit" value="Editar"></center>
			  </div>
		</form>
