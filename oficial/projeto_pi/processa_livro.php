...
$query = "INSERT INTO LIVRO(nome_livro, genero_livro, editora_livro, autor_livro, quant_exemp) VALUES('$nome_livro', '$genero_livro', '$editora_livro', '$autor_livro', $quant_exemp)";
